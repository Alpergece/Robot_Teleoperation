...
class TeleopPR2Keyboard
{
  ...
  trajectory_msgs::JointTrajectory gripper_right_open_;
  trajectory_msgs::JointTrajectory gripper_right_close_;
  ...
  void init()
  {
    ...
    cmd_right_.pose.position.x=0.345216155052;
    cmd_right_.pose.position.y=-0.57;
    cmd_right_.pose.position.z=-0.40;
    ...
    // gripper_right_open_.position[0]=0.04; //real robot in m
    // gripper_right_open_.position[1]=0.04;
    ...
    ros::Time zero_time;
    zero_time = ros::Time();
    gripper_right_open_.joint_names.resize(2);
    gripper_right_open_.joint_names[0]="gripper_right_left_finger_joint";
    gripper_right_open_.joint_names[1]="gripper_right_right_finger_joint";
    gripper_right_open_.points.resize(1);
    gripper_right_open_.points[0].positions.resize(2);
    // gripper_right_open_.points[0].velocities.resize(2);
    gripper_right_open_.header.stamp = zero_time;
    gripper_right_open_.points[0].positions[0]=0.04;
    gripper_right_open_.points[0].positions[1]=0.04;
    gripper_right_open_.points[0].time_from_start = ros::Duration(0.1);

    gripper_right_close_.joint_names.resize(2);
    gripper_right_close_.joint_names[0]="gripper_right_left_finger_joint";
    gripper_right_close_.joint_names[1]="gripper_right_right_finger_joint";
    gripper_right_close_.points.resize(1);
    gripper_right_close_.points[0].positions.resize(2);
    // gripper_right_close_.points[0].velocities.resize(2);
    gripper_right_close_.header.stamp =zero_time;
    gripper_right_close_.points[0].positions[0]=0.0;
    gripper_right_close_.points[0].positions[1]=0.0;
    gripper_right_close_.points[0].time_from_start = ros::Duration(0.1);
    ...
    gripper_pub_right_ = n_.advertise<trajectory_msgs::JointTrajectory>("/gripper_right_controller/command", 1);
...
void TeleopPR2Keyboard::keyboardLoop()
{
  ...
  for(;;)
  {
    ...
    case KEYCODE_W:
      cmd_right_.pose.position.x = cmd_right_.pose.position.x+TRANS_V;
      dirty = true;
      break;
    case KEYCODE_S:
      cmd_right_.pose.position.x = cmd_right_.pose.position.x-TRANS_V;
      ...
      break;
    case KEYCODE_A:
      cmd_right_.pose.position.y = cmd_right_.pose.position.y+TRANS_V;
      dirty = true;
      break;
    case KEYCODE_D:
      cmd_right_.pose.position.y = cmd_right_.pose.position.y-TRANS_V;
      ...
      break;
    case KEYCODE_Q:
      cmd_right_.pose.position.z = cmd_right_.pose.position.z+TRANS_V;
      dirty = true;
      break;
    case KEYCODE_E:
      cmd_right_.pose.position.z = cmd_right_.pose.position.z-TRANS_V;
